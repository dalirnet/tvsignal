 ...
 * @exports
 */
export declare type ChartSourceTypes = {
 ...
 * @exports
 */
export declare type ChartSourceDetailTypes = {
 ...
 * @exports
 */
export declare type ChartSignalTypes = {
    symbol?: string;
    base?: string;
    quote?: string;
    exchange?: string;
 ...
 * @exports
 */
export declare type IdeaFilterTypes = {
    side?: IdeaTypes["side"];
 ...
 * @exports
 */
export declare type UserInfoResponseTypes = {
    id: number;
    username: string;
